...
This module handles secure access to Secrets Manager, Redshift, and S3.
...
def initialize_aws_services(region_name: str = 'eu-west-1') -> tuple:
    """
    Initializes necessary AWS services.
    ...
    try:
        ...
        return secrets_manager, s3_manager
