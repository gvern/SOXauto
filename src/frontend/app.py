...
def main():
    ...
    if run_btn:
        ...
        with tabs[1]:
            ...
            adj_amt, proof_df_vtc = calculate_vtc_adjustment(
                data["IPE_08"], cat_cr03, fx_converter=fx_converter
            )
            c1, c2 = st.columns([1, 3])
